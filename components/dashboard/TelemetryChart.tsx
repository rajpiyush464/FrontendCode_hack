    ...
    <Card className={cn('p-4 sm:p-5', expanded && 'col-span-full', className)}>
      ...
      <div id={chartId} style={{ height: expanded ? 400 : height }}>
        {loading || !series ? (
         ...
         <ResponsiveContainer width="100%" height="100%">
            <AreaChart 
              key={series.metric} // 🟢 STABILIZES RE-RENDERS: Prevents parent audio/state updates from resetting the canvas context
              data={data} 
            ...
            >
              ...
              <Area
                ...
                strokeWidth={2}
                fill={`url(#${gradientId})`}
                isAnimationActive={true}   // 🟢 Re-enable path shifting
                animationDuration={150}    // 🟢 Fast transition matching typical WebSocket stream rates (150ms)
              />
            </AreaChart>
          </ResponsiveContainer>
        )}
